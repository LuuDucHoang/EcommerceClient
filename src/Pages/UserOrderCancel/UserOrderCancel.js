...
import { getCancelUserOrders, getCart, insertCart } from '~/redux/apiRequest';
//import style,img
import style from './UserOrderCancel.module.scss';
...
function UserOrderCancel() {
    ...
    const reBuy = async (data) => {
        await insertCart(id, data, accessToken, axiosJWT);
        setRefresh(Math.random());
    };

    useEffect(() => {
        const fethOrders = async () => {
            const orders = await getCancelUserOrders(id, accessToken, axiosJWT);
    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('container')}>
                <SupNavOrder active4></SupNavOrder>
                                ...
                                <div className={cx('orderItemBody')}>
                                    ...
                                    <div className={cx('itemFooter')}>
                                        ...
                                        <div className={cx('buttonGroup')}>
                                            <Button bgGreen onClick={() => reBuy(item?.orders)} ml5 textWhite>
                                                Mua lại
                                            </Button>
